...
domain: gates
title: "Rz Gate"
summary: "An interactive introduction to Rz Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, rz-gate]
equations: [rz-gate]
visualizations: [rz-gate-visual]
experiments: [rz-gate-experiment]
...
An interactive introduction to Rz Gate and its role in quantum science or computing.
