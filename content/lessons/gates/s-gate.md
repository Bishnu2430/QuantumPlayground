...
domain: gates
title: "S Gate"
summary: "An interactive introduction to S Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, s-gate]
equations: [s-gate]
visualizations: [s-gate-visual]
experiments: [s-gate-experiment]
...
An interactive introduction to S Gate and its role in quantum science or computing.
