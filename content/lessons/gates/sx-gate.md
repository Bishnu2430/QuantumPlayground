...
domain: gates
title: "Sx Gate"
summary: "An interactive introduction to Sx Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, sx-gate]
equations: [sx-gate]
visualizations: [sx-gate-visual]
experiments: [sx-gate-experiment]
...
An interactive introduction to Sx Gate and its role in quantum science or computing.
