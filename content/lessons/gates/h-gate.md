...
domain: gates
title: "Hadamard Gate"
summary: "A unitary basis-changing operation with H|0> = |+> and H|1> = |->."
level: foundational
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, h-gate]
equations: [h-gate]
visualizations: [h-gate-visual]
experiments: [h-gate-experiment]
...
A unitary basis-changing operation with H|0> = |+> and H|1> = |->.
