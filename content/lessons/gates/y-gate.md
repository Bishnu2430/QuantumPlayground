...
domain: gates
title: "Y Gate"
summary: "An interactive introduction to Y Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, y-gate]
equations: [y-gate]
visualizations: [y-gate-visual]
experiments: [y-gate-experiment]
...
An interactive introduction to Y Gate and its role in quantum science or computing.
