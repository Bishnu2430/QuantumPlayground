...
domain: gates
title: "Rx Gate"
summary: "An interactive introduction to Rx Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, rx-gate]
equations: [rx-gate]
visualizations: [rx-gate-visual]
experiments: [rx-gate-experiment]
...
An interactive introduction to Rx Gate and its role in quantum science or computing.
