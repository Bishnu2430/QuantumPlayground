...
domain: gates
title: "Swap"
summary: "An interactive introduction to Swap and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, swap]
equations: [swap]
visualizations: [swap-visual]
experiments: [swap-experiment]
...
An interactive introduction to Swap and its role in quantum science or computing.
