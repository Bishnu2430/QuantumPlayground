---
id: euler-angle-decomposition
type: lesson
domain: gates
title: "Euler Angle Decomposition"
summary: "An interactive introduction to Euler Angle Decomposition and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, euler-angle-decomposition]
equations: [euler-angle-decomposition]
visualizations: [euler-angle-decomposition-visual]
experiments: [euler-angle-decomposition-experiment]
...
An interactive introduction to Euler Angle Decomposition and its role in quantum science or computing.
