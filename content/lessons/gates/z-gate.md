...
domain: gates
title: "Z Gate"
summary: "An interactive introduction to Z Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, z-gate]
equations: [z-gate]
visualizations: [z-gate-visual]
experiments: [z-gate-experiment]
...
An interactive introduction to Z Gate and its role in quantum science or computing.
