...
domain: gates
title: "X Gate"
summary: "An interactive introduction to X Gate and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [gates, x-gate]
equations: [x-gate]
visualizations: [x-gate-visual]
experiments: [x-gate-experiment]
...
An interactive introduction to X Gate and its role in quantum science or computing.
