...
summary: "An interactive introduction to Expectation Values and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [measurement, expectation-values]
equations: [expectation-values]
visualizations: [expectation-values-visual]
experiments: [expectation-values-experiment]
...
An interactive introduction to Expectation Values and its role in quantum science or computing.
