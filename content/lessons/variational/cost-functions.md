...
summary: "An interactive introduction to Cost Functions and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [variational, cost-functions]
equations: [cost-functions]
visualizations: [cost-functions-visual]
experiments: [cost-functions-experiment]
...
An interactive introduction to Cost Functions and its role in quantum science or computing.
