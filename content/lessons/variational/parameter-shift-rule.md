...
summary: "An interactive introduction to Parameter Shift Rule and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [variational, parameter-shift-rule]
equations: [parameter-shift-rule]
visualizations: [parameter-shift-rule-visual]
experiments: [parameter-shift-rule-experiment]
...
An interactive introduction to Parameter Shift Rule and its role in quantum science or computing.
