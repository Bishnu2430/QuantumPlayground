...
summary: "An interactive introduction to Gradient Descent and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [variational, gradient-descent]
equations: [gradient-descent]
visualizations: [gradient-descent-visual]
experiments: [gradient-descent-experiment]
...
An interactive introduction to Gradient Descent and its role in quantum science or computing.
