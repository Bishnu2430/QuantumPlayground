...
domain: history
title: "Bohr Model"
summary: "An interactive introduction to Bohr Model and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [history, bohr-model]
equations: [bohr-model]
visualizations: [bohr-model-visual]
experiments: [bohr-model-experiment]
...
An interactive introduction to Bohr Model and its role in quantum science or computing.
