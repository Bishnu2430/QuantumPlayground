...
domain: multi-qubit
title: "Schmidt Rank"
summary: "An interactive introduction to Schmidt Rank and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [multi-qubit, schmidt-rank]
equations: [schmidt-rank]
visualizations: [schmidt-rank-visual]
experiments: [schmidt-rank-experiment]
...
An interactive introduction to Schmidt Rank and its role in quantum science or computing.
