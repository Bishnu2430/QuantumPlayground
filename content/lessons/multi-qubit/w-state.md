...
domain: multi-qubit
title: "W State"
summary: "An interactive introduction to W State and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [multi-qubit, w-state]
equations: [w-state]
visualizations: [w-state-visual]
experiments: [w-state-experiment]
...
An interactive introduction to W State and its role in quantum science or computing.
