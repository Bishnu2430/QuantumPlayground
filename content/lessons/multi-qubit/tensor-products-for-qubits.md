---
id: tensor-products-for-qubits
type: lesson
domain: multi-qubit
title: "Tensor Products For Qubits"
summary: "An interactive introduction to Tensor Products For Qubits and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [multi-qubit, tensor-products-for-qubits]
equations: [tensor-products-for-qubits]
visualizations: [tensor-products-for-qubits-visual]
experiments: [tensor-products-for-qubits-experiment]
references: [nielsen-chuang, gentle-introduction, qiskit-docs]
---

# Tensor Products For Qubits

## What this means

An interactive introduction to Tensor Products For Qubits and its role in quantum science or computing.
