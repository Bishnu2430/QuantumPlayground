...
domain: multi-qubit
title: "Ghz State"
summary: "An interactive introduction to Ghz State and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [multi-qubit, ghz-state]
equations: [ghz-state]
visualizations: [ghz-state-visual]
experiments: [ghz-state-experiment]
...
An interactive introduction to Ghz State and its role in quantum science or computing.
