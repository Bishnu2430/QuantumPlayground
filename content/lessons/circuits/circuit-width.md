...
domain: circuits
title: "Circuit Width"
summary: "An interactive introduction to Circuit Width and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [circuits, circuit-width]
equations: [circuit-width]
visualizations: [circuit-width-visual]
experiments: [circuit-width-experiment]
...
An interactive introduction to Circuit Width and its role in quantum science or computing.
