...
summary: "An interactive introduction to Backend Concepts and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [circuits, backend-concepts]
equations: [backend-concepts]
visualizations: [backend-concepts-visual]
experiments: [backend-concepts-experiment]
...
An interactive introduction to Backend Concepts and its role in quantum science or computing.
