...
summary: "An interactive introduction to Matrix Multiplication and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [mathematics, matrix-multiplication]
equations: [matrix-multiplication]
visualizations: [matrix-multiplication-visual]
experiments: [matrix-multiplication-experiment]
...
An interactive introduction to Matrix Multiplication and its role in quantum science or computing.
