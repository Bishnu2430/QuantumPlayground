---
id: operator-tensor-products
type: lesson
domain: mathematics
title: "Operator Tensor Products"
summary: "An interactive introduction to Operator Tensor Products and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [mathematics, operator-tensor-products]
equations: [operator-tensor-products]
visualizations: [operator-tensor-products-visual]
experiments: [operator-tensor-products-experiment]
...
An interactive introduction to Operator Tensor Products and its role in quantum science or computing.
