...
domain: mathematics
title: "Euler Formula"
summary: "An interactive introduction to Euler Formula and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [mathematics, euler-formula]
equations: [euler-formula]
visualizations: [euler-formula-visual]
experiments: [euler-formula-experiment]
...
An interactive introduction to Euler Formula and its role in quantum science or computing.
