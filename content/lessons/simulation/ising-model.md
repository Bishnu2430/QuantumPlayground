...
domain: simulation
title: "Ising Model"
summary: "An interactive introduction to Ising Model and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [simulation, ising-model]
equations: [ising-model]
visualizations: [ising-model-visual]
experiments: [ising-model-experiment]
...
An interactive introduction to Ising Model and its role in quantum science or computing.
