---
id: first-order-trotter
type: lesson
domain: simulation
title: "First Order Trotter"
summary: "An interactive introduction to First Order Trotter and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [simulation, first-order-trotter]
equations: [first-order-trotter]
visualizations: [first-order-trotter-visual]
experiments: [first-order-trotter-experiment]
...
An interactive introduction to First Order Trotter and its role in quantum science or computing.
