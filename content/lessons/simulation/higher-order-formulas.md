---
id: higher-order-formulas
type: lesson
domain: simulation
title: "Higher Order Formulas"
summary: "An interactive introduction to Higher Order Formulas and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [simulation, higher-order-formulas]
equations: [higher-order-formulas]
visualizations: [higher-order-formulas-visual]
experiments: [higher-order-formulas-experiment]
...
An interactive introduction to Higher Order Formulas and its role in quantum science or computing.
