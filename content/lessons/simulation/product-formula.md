...
summary: "An interactive introduction to Product Formula and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [simulation, product-formula]
equations: [product-formula]
visualizations: [product-formula-visual]
experiments: [product-formula-experiment]
...
An interactive introduction to Product Formula and its role in quantum science or computing.
