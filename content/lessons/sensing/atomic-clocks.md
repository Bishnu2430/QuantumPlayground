...
domain: sensing
title: "Atomic Clocks"
summary: "An interactive introduction to Atomic Clocks and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [sensing, atomic-clocks]
equations: [atomic-clocks]
visualizations: [atomic-clocks-visual]
experiments: [atomic-clocks-experiment]
...
An interactive introduction to Atomic Clocks and its role in quantum science or computing.
