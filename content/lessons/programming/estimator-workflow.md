---
id: estimator-workflow
type: lesson
domain: programming
title: "Estimator Workflow"
summary: "An interactive introduction to Estimator Workflow and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [programming, estimator-workflow]
equations: [estimator-workflow]
visualizations: [estimator-workflow-visual]
experiments: [estimator-workflow-experiment]
...
An interactive introduction to Estimator Workflow and its role in quantum science or computing.
