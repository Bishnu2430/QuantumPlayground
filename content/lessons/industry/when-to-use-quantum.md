---
id: when-to-use-quantum
type: lesson
domain: industry
title: "When To Use Quantum"
summary: "An interactive introduction to When To Use Quantum and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [industry, when-to-use-quantum]
equations: [when-to-use-quantum]
visualizations: [when-to-use-quantum-visual]
experiments: [when-to-use-quantum-experiment]
...
An interactive introduction to When To Use Quantum and its role in quantum science or computing.
