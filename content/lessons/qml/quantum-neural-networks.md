...
summary: "An interactive introduction to Quantum Neural Networks and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [qml, quantum-neural-networks]
equations: [quantum-neural-networks]
visualizations: [quantum-neural-networks-visual]
experiments: [quantum-neural-networks-experiment]
...
An interactive introduction to Quantum Neural Networks and its role in quantum science or computing.
