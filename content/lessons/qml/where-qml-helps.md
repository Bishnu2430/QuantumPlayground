...
type: lesson
domain: qml
title: "Where Qml Helps"
summary: "An interactive introduction to Where Qml Helps and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [qml, where-qml-helps]
equations: [where-qml-helps]
visualizations: [where-qml-helps-visual]
experiments: [where-qml-helps-experiment]
...
An interactive introduction to Where Qml Helps and its role in quantum science or computing.
