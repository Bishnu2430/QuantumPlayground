---
id: quantum-convolutional-networks
type: lesson
domain: qml
title: "Quantum Convolutional Networks"
summary: "An interactive introduction to Quantum Convolutional Networks and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [qml, quantum-convolutional-networks]
equations: [quantum-convolutional-networks]
visualizations: [quantum-convolutional-networks-visual]
experiments: [quantum-convolutional-networks-experiment]
...
An interactive introduction to Quantum Convolutional Networks and its role in quantum science or computing.
