...
summary: "An interactive introduction to Bit Flip Channel and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [noise, bit-flip-channel]
equations: [bit-flip-channel]
visualizations: [bit-flip-channel-visual]
experiments: [bit-flip-channel-experiment]
...
An interactive introduction to Bit Flip Channel and its role in quantum science or computing.
