---
id: noise-vs-circuit-depth
type: lesson
domain: noise
title: "Noise Vs Circuit Depth"
summary: "An interactive introduction to Noise Vs Circuit Depth and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [noise, noise-vs-circuit-depth]
equations: [noise-vs-circuit-depth]
visualizations: [noise-vs-circuit-depth-visual]
experiments: [noise-vs-circuit-depth-experiment]
references: [nielsen-chuang, gentle-introduction, qiskit-docs]
---

# Noise Vs Circuit Depth

## What this means

An interactive introduction to Noise Vs Circuit Depth and its role in quantum science or computing.
