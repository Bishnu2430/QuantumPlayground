...
summary: "An interactive introduction to Probabilistic Error Cancellation and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [noise, probabilistic-error-cancellation]
equations: [probabilistic-error-cancellation]
visualizations: [probabilistic-error-cancellation-visual]
experiments: [probabilistic-error-cancellation-experiment]
...
An interactive introduction to Probabilistic Error Cancellation and its role in quantum science or computing.
