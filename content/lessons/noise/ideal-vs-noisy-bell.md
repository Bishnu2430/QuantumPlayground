---
id: ideal-vs-noisy-bell
type: lesson
domain: noise
title: "Ideal Vs Noisy Bell"
summary: "An interactive introduction to Ideal Vs Noisy Bell and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [noise, ideal-vs-noisy-bell]
equations: [ideal-vs-noisy-bell]
visualizations: [ideal-vs-noisy-bell-visual]
experiments: [ideal-vs-noisy-bell-experiment]
...
An interactive introduction to Ideal Vs Noisy Bell and its role in quantum science or computing.
