---
id: superdense-coding-network
type: lesson
domain: networks
title: "Superdense Coding Network"
summary: "An interactive introduction to Superdense Coding Network and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [networks, superdense-coding-network]
equations: [superdense-coding-network]
visualizations: [superdense-coding-network-visual]
experiments: [superdense-coding-network-experiment]
references: [nielsen-chuang, gentle-introduction, qiskit-docs]
---

# Superdense Coding Network

## What this means

An interactive introduction to Superdense Coding Network and its role in quantum science or computing.
