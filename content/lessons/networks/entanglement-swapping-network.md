---
id: entanglement-swapping-network
type: lesson
domain: networks
title: "Entanglement Swapping Network"
summary: "An interactive introduction to Entanglement Swapping Network and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [networks, entanglement-swapping-network]
equations: [entanglement-swapping-network]
visualizations: [entanglement-swapping-network-visual]
experiments: [entanglement-swapping-network-experiment]
references: [nielsen-chuang, gentle-introduction, qiskit-docs]
---

# Entanglement Swapping Network

## What this means

An interactive introduction to Entanglement Swapping Network and its role in quantum science or computing.
