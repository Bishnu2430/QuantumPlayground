---
id: openqasm-overview
type: lesson
domain: compilation
title: "Openqasm Overview"
summary: "An interactive introduction to Openqasm Overview and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [compilation, openqasm-overview]
equations: [openqasm-overview]
visualizations: [openqasm-overview-visual]
experiments: [openqasm-overview-experiment]
...
An interactive introduction to Openqasm Overview and its role in quantum science or computing.
