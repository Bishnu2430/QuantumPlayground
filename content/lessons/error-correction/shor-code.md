...
title: "Shor Code"
summary: "An interactive introduction to Shor Code and its role in quantum science or computing."
level: advanced
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, shor-code]
equations: [shor-code]
visualizations: [shor-code-visual]
experiments: [shor-code-experiment]
...
An interactive introduction to Shor Code and its role in quantum science or computing.
