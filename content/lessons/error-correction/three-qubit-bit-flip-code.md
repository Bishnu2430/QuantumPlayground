---
id: three-qubit-bit-flip-code
type: lesson
domain: error-correction
title: "Three Qubit Bit Flip Code"
summary: "An interactive introduction to Three Qubit Bit Flip Code and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, three-qubit-bit-flip-code]
equations: [three-qubit-bit-flip-code]
visualizations: [three-qubit-bit-flip-code-visual]
experiments: [three-qubit-bit-flip-code-experiment]
...
An interactive introduction to Three Qubit Bit Flip Code and its role in quantum science or computing.
