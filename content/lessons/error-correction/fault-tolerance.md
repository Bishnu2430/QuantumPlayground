...
summary: "An interactive introduction to Fault Tolerance and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, fault-tolerance]
equations: [fault-tolerance]
visualizations: [fault-tolerance-visual]
experiments: [fault-tolerance-experiment]
...
An interactive introduction to Fault Tolerance and its role in quantum science or computing.
