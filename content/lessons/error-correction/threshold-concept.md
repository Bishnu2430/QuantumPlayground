...
summary: "An interactive introduction to Threshold Concept and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, threshold-concept]
equations: [threshold-concept]
visualizations: [threshold-concept-visual]
experiments: [threshold-concept-experiment]
...
An interactive introduction to Threshold Concept and its role in quantum science or computing.
