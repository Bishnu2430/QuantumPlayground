---
id: three-qubit-phase-flip-code
type: lesson
domain: error-correction
title: "Three Qubit Phase Flip Code"
summary: "An interactive introduction to Three Qubit Phase Flip Code and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, three-qubit-phase-flip-code]
equations: [three-qubit-phase-flip-code]
visualizations: [three-qubit-phase-flip-code-visual]
experiments: [three-qubit-phase-flip-code-experiment]
...
An interactive introduction to Three Qubit Phase Flip Code and its role in quantum science or computing.
