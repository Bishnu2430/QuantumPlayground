---
id: surface-code-intuition
type: lesson
domain: error-correction
title: "Surface Code Intuition"
summary: "An interactive introduction to Surface Code Intuition and its role in quantum science or computing."
level: advanced
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, surface-code-intuition]
equations: [surface-code-intuition]
visualizations: [surface-code-intuition-visual]
experiments: [surface-code-intuition-experiment]
...
An interactive introduction to Surface Code Intuition and its role in quantum science or computing.
