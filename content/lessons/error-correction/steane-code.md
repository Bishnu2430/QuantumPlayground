...
title: "Steane Code"
summary: "An interactive introduction to Steane Code and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, steane-code]
equations: [steane-code]
visualizations: [steane-code-visual]
experiments: [steane-code-experiment]
...
An interactive introduction to Steane Code and its role in quantum science or computing.
