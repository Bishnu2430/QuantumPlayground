...
summary: "An interactive introduction to Phase Flip Error and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [error-correction, phase-flip-error]
equations: [phase-flip-error]
visualizations: [phase-flip-error-visual]
experiments: [phase-flip-error-experiment]
...
An interactive introduction to Phase Flip Error and its role in quantum science or computing.
