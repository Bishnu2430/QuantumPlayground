---
id: qubit-in-one-minute
type: lesson
domain: introduction
title: "Qubit In One Minute"
summary: "An interactive introduction to Qubit In One Minute and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [introduction, qubit-in-one-minute]
equations: [qubit-in-one-minute]
visualizations: [qubit-in-one-minute-visual]
experiments: [qubit-in-one-minute-experiment]
...
An interactive introduction to Qubit In One Minute and its role in quantum science or computing.
