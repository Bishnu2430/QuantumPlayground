...
domain: introduction
title: "Circuit Model"
summary: "An interactive introduction to Circuit Model and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [introduction, circuit-model]
equations: [circuit-model]
visualizations: [circuit-model-visual]
experiments: [circuit-model-experiment]
...
An interactive introduction to Circuit Model and its role in quantum science or computing.
