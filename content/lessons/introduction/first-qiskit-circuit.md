...
type: lesson
domain: introduction
title: "First Qiskit Circuit"
summary: "An interactive introduction to First Qiskit Circuit and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [introduction, first-qiskit-circuit]
equations: [first-qiskit-circuit]
visualizations: [first-qiskit-circuit-visual]
experiments: [first-qiskit-circuit-experiment]
...
An interactive introduction to First Qiskit Circuit and its role in quantum science or computing.
