...
type: lesson
domain: cryptography
title: "Qkd Error Rates"
summary: "An interactive introduction to Qkd Error Rates and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [cryptography, qkd-error-rates]
equations: [qkd-error-rates]
visualizations: [qkd-error-rates-visual]
experiments: [qkd-error-rates-experiment]
...
An interactive introduction to Qkd Error Rates and its role in quantum science or computing.
