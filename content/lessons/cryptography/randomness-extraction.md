---
id: randomness-extraction
type: lesson
domain: cryptography
title: "Randomness Extraction"
summary: "An interactive introduction to Randomness Extraction and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [cryptography, randomness-extraction]
equations: [randomness-extraction]
visualizations: [randomness-extraction-visual]
experiments: [randomness-extraction-experiment]
...
An interactive introduction to Randomness Extraction and its role in quantum science or computing.
