---
id: quantum-threat-model
type: lesson
domain: cryptography
title: "Quantum Threat Model"
summary: "An interactive introduction to Quantum Threat Model and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [cryptography, quantum-threat-model]
equations: [quantum-threat-model]
visualizations: [quantum-threat-model-visual]
experiments: [quantum-threat-model-experiment]
...
An interactive introduction to Quantum Threat Model and its role in quantum science or computing.
