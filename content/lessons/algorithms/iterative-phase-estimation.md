---
id: iterative-phase-estimation
type: lesson
domain: algorithms
title: "Iterative Phase Estimation"
summary: "An interactive introduction to Iterative Phase Estimation and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [algorithms, iterative-phase-estimation]
equations: [iterative-phase-estimation]
visualizations: [iterative-phase-estimation-visual]
experiments: [iterative-phase-estimation-experiment]
...
An interactive introduction to Iterative Phase Estimation and its role in quantum science or computing.
