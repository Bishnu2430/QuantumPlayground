...
summary: "A unitary transform that maps computational-basis states into Fourier superpositions."
level: advanced
audience: [undergraduate, beginner, engineer, researcher]
tags: [algorithms, qft]
equations: [qft]
visualizations: [qft-visual]
experiments: [qft-experiment]
...
A unitary transform that maps computational-basis states into Fourier superpositions.
