...
summary: "A quantum algorithm that reduces factoring to order finding."
level: advanced
audience: [undergraduate, beginner, engineer, researcher]
tags: [algorithms, shor]
equations: [shor]
visualizations: [shor-visual]
experiments: [shor-experiment]
...
A quantum algorithm that reduces factoring to order finding.
