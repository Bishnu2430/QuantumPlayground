...
summary: "An interactive introduction to Hidden Subgroup Problem and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [algorithms, hidden-subgroup-problem]
equations: [hidden-subgroup-problem]
visualizations: [hidden-subgroup-problem-visual]
experiments: [hidden-subgroup-problem-experiment]
...
An interactive introduction to Hidden Subgroup Problem and its role in quantum science or computing.
