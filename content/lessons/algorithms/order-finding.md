...
domain: algorithms
title: "Order Finding"
summary: "An interactive introduction to Order Finding and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [algorithms, order-finding]
equations: [order-finding]
visualizations: [order-finding-visual]
experiments: [order-finding-experiment]
...
An interactive introduction to Order Finding and its role in quantum science or computing.
