...
type: lesson
domain: qubits
title: "Gate Geometries"
summary: "An interactive introduction to Gate Geometries and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [qubits, gate-geometries]
equations: [gate-geometries]
visualizations: [gate-geometries-visual]
experiments: [gate-geometries-experiment]
...
An interactive introduction to Gate Geometries and its role in quantum science or computing.
