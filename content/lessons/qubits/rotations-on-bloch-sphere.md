---
id: rotations-on-bloch-sphere
type: lesson
domain: qubits
title: "Rotations On Bloch Sphere"
summary: "An interactive introduction to Rotations On Bloch Sphere and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [qubits, rotations-on-bloch-sphere]
equations: [rotations-on-bloch-sphere]
visualizations: [rotations-on-bloch-sphere-visual]
experiments: [rotations-on-bloch-sphere-experiment]
...
An interactive introduction to Rotations On Bloch Sphere and its role in quantum science or computing.
