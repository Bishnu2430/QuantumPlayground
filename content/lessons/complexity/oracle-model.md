...
domain: complexity
title: "Oracle Model"
summary: "An interactive introduction to Oracle Model and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [complexity, oracle-model]
equations: [oracle-model]
visualizations: [oracle-model-visual]
experiments: [oracle-model-experiment]
...
An interactive introduction to Oracle Model and its role in quantum science or computing.
