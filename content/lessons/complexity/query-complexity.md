...
summary: "An interactive introduction to Query Complexity and its role in quantum science or computing."
level: advanced
audience: [undergraduate, beginner, engineer, researcher]
tags: [complexity, query-complexity]
equations: [query-complexity]
visualizations: [query-complexity-visual]
experiments: [query-complexity-experiment]
...
An interactive introduction to Query Complexity and its role in quantum science or computing.
