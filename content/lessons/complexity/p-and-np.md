...
domain: complexity
title: "P And Np"
summary: "An interactive introduction to P And Np and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [complexity, p-and-np]
equations: [p-and-np]
visualizations: [p-and-np-visual]
experiments: [p-and-np-experiment]
...
An interactive introduction to P And Np and its role in quantum science or computing.
