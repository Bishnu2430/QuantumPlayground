---
id: input-output-bottlenecks
type: lesson
domain: complexity
title: "Input Output Bottlenecks"
summary: "An interactive introduction to Input Output Bottlenecks and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [complexity, input-output-bottlenecks]
equations: [input-output-bottlenecks]
visualizations: [input-output-bottlenecks-visual]
experiments: [input-output-bottlenecks-experiment]
...
An interactive introduction to Input Output Bottlenecks and its role in quantum science or computing.
