...
summary: "An interactive introduction to Relative Entropy and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [information-theory, relative-entropy]
equations: [relative-entropy]
visualizations: [relative-entropy-visual]
experiments: [relative-entropy-experiment]
...
An interactive introduction to Relative Entropy and its role in quantum science or computing.
