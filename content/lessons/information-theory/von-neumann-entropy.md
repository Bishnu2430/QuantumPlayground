...
summary: "An interactive introduction to Von Neumann Entropy and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [information-theory, von-neumann-entropy]
equations: [von-neumann-entropy]
visualizations: [von-neumann-entropy-visual]
experiments: [von-neumann-entropy-experiment]
...
An interactive introduction to Von Neumann Entropy and its role in quantum science or computing.
