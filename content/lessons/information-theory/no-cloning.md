...
summary: "No universal physical process can perfectly copy an arbitrary unknown quantum state."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [information-theory, no-cloning]
equations: [no-cloning]
visualizations: [no-cloning-visual]
experiments: [no-cloning-experiment]
...
No universal physical process can perfectly copy an arbitrary unknown quantum state.
