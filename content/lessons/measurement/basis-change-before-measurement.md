---
id: basis-change-before-measurement
type: lesson
domain: measurement
title: "Basis Change Before Measurement"
summary: "An interactive introduction to Basis Change Before Measurement and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [measurement, basis-change-before-measurement]
equations: [basis-change-before-measurement]
visualizations: [basis-change-before-measurement-visual]
experiments: [basis-change-before-measurement-experiment]
references: [nielsen-chuang, gentle-introduction, qiskit-docs]
---

# Basis Change Before Measurement

## What this means

An interactive introduction to Basis Change Before Measurement and its role in quantum science or computing.
