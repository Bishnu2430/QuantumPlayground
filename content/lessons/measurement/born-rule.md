...
domain: measurement
title: "The Born Rule"
summary: "Measurement probabilities are obtained from squared magnitudes of amplitudes in the chosen basis."
level: foundational
audience: [undergraduate, beginner, engineer, researcher]
tags: [measurement, born-rule]
equations: [born-rule]
visualizations: [born-rule-visual]
experiments: [born-rule-experiment]
...
Measurement probabilities are obtained from squared magnitudes of amplitudes in the chosen basis.
