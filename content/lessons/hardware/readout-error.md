...
domain: hardware
title: "Readout Error"
summary: "An interactive introduction to Readout Error and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [hardware, readout-error]
equations: [readout-error]
visualizations: [readout-error-visual]
experiments: [readout-error-experiment]
...
An interactive introduction to Readout Error and its role in quantum science or computing.
