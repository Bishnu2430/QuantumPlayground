...
domain: hardware
title: "Gate Fidelity"
summary: "An interactive introduction to Gate Fidelity and its role in quantum science or computing."
level: intermediate
audience: [undergraduate, beginner, engineer, researcher]
tags: [hardware, gate-fidelity]
equations: [gate-fidelity]
visualizations: [gate-fidelity-visual]
experiments: [gate-fidelity-experiment]
...
An interactive introduction to Gate Fidelity and its role in quantum science or computing.
